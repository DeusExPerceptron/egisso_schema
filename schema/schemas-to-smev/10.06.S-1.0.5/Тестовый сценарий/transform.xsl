...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:ns3="urn://egisso-ru/msg/10.06.S/1.0.5"
                xmlns:ns1="urn://egisso-ru/types/package-RAF/1.0.6"
    ...
    <xsl:template match="/">
        <xsl:choose>
            <xsl:when test="//ns3:data/ns1:package/ns1:packageId='e30bf807-36f8-4f29-8b1f-ca1f10cc0001'">
                <ns7:response>
                    <ns4:protocol>
                        <ns4:packageResult>
            ...
            <xsl:when test="//ns3:data/ns1:package/ns1:packageId='e30bf807-36f8-4f29-8b1f-ca1f10cc0002'">
                <ns7:response>
                    <ns4:protocol>
                        <ns4:packageResult>
